...
<div class="text-center">
    ...
    <h3> To Use Orangesoft to Build your Website</h3>
    <p>
        Your website is your storefont. Don't risk damaging your business and your brand by leaving it in the hands of amatuers!
        Here's 8 Reasons why Orangesoft is the ultimate choice as your Website development partner.
    </p>
</div>
<div class="container-fluid text-center"> 
<div id="all-design" class="row">
    <div id="design" class="push text-center col-md-7">
        <h2 class="container-fluid"><strong><span class="nums1 text-center"> 1 </span> <span class="brag">We've been around for a LONG time!</span></strong></h2>
...
<div id="all-design" class="row">
    <div id="design" class="push text-center col-md-7">
        <h2><strong><span class="nums1 text-center"> 1 </span> We've been around for a LONG time!</strong></h2>
...
<div id="all-design" class="row">
    <div id="design" class="push text-center col-md-7">
        <h2><strong><span class="nums1 text-center"> 1 </span> We've been around for a LONG time!</strong></h2>
           <p class="paragraph-design"> Our team has been serving Malaysian 
            businesses since 2007. We are here to stay.
            To be more specific, we have created over 
            500 websites and counting. Make no mistake 
            about this, you can trust us to be your
